...
st.header("Smart ATS Resume Reviewer")
st.markdown(
    "<h6 style='text-align: left; color: gray;'>A Product by VITResumeX</h6>",
...
footer = """
---
#### Made By [Pratik](https://www.linkedin.com/in/pratik-biradar/)
For Queries, Reach out on [LinkedIn](https://www.linkedin.com/in/pratik-biradar/)  
